...
for COMBINATION in "${COMBINATIONS[@]}"; do
    ...
    for BATCH_SIZE in "${BATCH_SIZES[@]}"; do
        LOG_FILE="${LBM_DIR}/Meta-Llama-3.1-70B_i${INPUT_LEN}_o${OUTPUT_LEN}_b${BATCH_SIZE}.log"
        JSON_FILE="${LBM_DIR}/Meta-Llama-3.1-70B_i${INPUT_LEN}_o${OUTPUT_LEN}_b${BATCH_SIZE}.json"
